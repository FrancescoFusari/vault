import { List, Tag, Network, FileText, Square, Settings } from "lucide-react";
    ...
    <div className="hidden md:flex fixed top-0 left-0 right-0 bg-background/80 backdrop-blur-lg border-b px-6 py-3 z-50">
      <div className="flex-1 flex items-center gap-6">
        ...
        <button
          ...
          className={`flex items-center gap-2 ${isActive('/settings') ? 'text-primary' : 'text-muted-foreground'} hover:text-primary transition-colors`}
        >
